...
def test_add_member_with_zero_permissions(backend: BackendInterface,
                                         navigator: Navigator,
                                         test_name: str) -> None:   
...
def test_add_member_without_can_add_block_permission(backend: BackendInterface,
                                                    navigator: Navigator,
                                                    test_name: str) -> None:
    """Test that a member without CAN_ADD_BLOCK permission should not be able to add blocks, and APDU device should refuse to sign subsequent blocks."""
