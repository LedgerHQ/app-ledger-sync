...
class SeedIdClient:
    def __init__(self, backend: BackendInterface) -> None:
        ...
        if self._device.type != DeviceType.NANOS:
            # LedgerPKI not supported on Nano S only
    ...
    def get_seed_id_async(self, challenge_data: bytes) -> Generator[None, None, None]:
        ...
        if self._pki_client is None:
            print(f"Ledger-PKI Not supported on Nano S")
        else:
            ...
            elif self._device.type == DeviceType.NANOX:
            ...
            elif self._device.type == DeviceType.STAX:
            ...
            elif self._device.type == DeviceType.FLEX:
