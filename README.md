...
For complete instructions, please refer to [Ledger dev portal](https://developers.ledger.com/docs/device-app/develop/quickstart).
...
you can proceed to the following steps to build your app.
...
The documents are available in the the directory `doc`:

- APDU.md: Describes the generic APDU format
- COMMANDS.md: describes the commands supported by the Application
